...
static const struct vulcan_special_key vulcan_key_map[] = {
	...
	PROFILE_KEY_PRESS(KEY_FN_F1, 0x00),
	PROFILE_KEY_RELEASE(KEY_FN_F1, 0x00),
	PROFILE_KEY_PRESS(KEY_FN_F2, 0x01),
	PROFILE_KEY_RELEASE(KEY_FN_F2, 0x01),
	PROFILE_KEY_PRESS(KEY_FN_F3, 0x02),
	PROFILE_KEY_RELEASE(KEY_FN_F3, 0x02),
	PROFILE_KEY_PRESS(KEY_FN_F4, 0x03),
	PROFILE_KEY_RELEASE(KEY_FN_F4, 0x03),
	{ .code = 0 },
};
